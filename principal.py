...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def open_path(self):
        self.path = QFileDialog.getExistingDirectory(self, "Open Directory", "/home", QFileDialog.ShowDirsOnly | QFileDialog.DontResolveSymlinks)
    ...
    def table_estoque(self):
        self.tw_estoque.setStyleSheet("QHeaderView{ color:black}; color:#fff;font-size: 15px;")
    ...
    def table_saida(self):
        self.tw_saida.setStyleSheet("QHeaderView{ color:black}; color:#fff;font-size: 15px;")
        cn  =  sqlite3.connect('system.db')
    ...
    def table_geral(self):
        self.tb_geral.setStyleSheet("QHeaderView{ color:black}; color:#fff;font-size: 15px;")
